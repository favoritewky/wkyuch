<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/ip|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1422844332', 'admin/tpl/ip');?><?php $_TPL['menunames'] = array(
		'index' => '管理首页',
		'config' => '站点设置',
		'privacy' => '隐私设置',
		'usergroup' => '用户组',
...
<br />
只有当用户处于本列表中的 IP 地址时才可以访问站点,列表以外的地址访问将视为 IP 被禁止。<br/>
每个 IP 一行，既可输入完整地址，也可只输入 IP 开头。<br/>
例如： <br/>"192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址，留空为所有 IP 均可访问。
<br />您当前的IP: <?=$onlineip?>
</td>
</tr>
...
<br/>
用户处于本列表中的 IP 地址禁止访问站点。每个 IP 一行，既可输入完整地址，也可只输入 IP 开头。<br/>
例如：<br/>
"192.168."(不含引号) 可匹配 192.168.0.0～192.168.255.255 范围内的所有地址<br/>
202.101.98.55<br/>
</td>
</tr>
</table>
